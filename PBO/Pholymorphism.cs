...
namespace Pholymorphism
{
    ...
    public class KaryawanPerjam : Karyawan
    {
        ...
        public KaryawanPerjam(string Depan, string Belakang, string ssn, decimal upahPerjam, decimal jamKerja): base(Depan, Belakang,ssn)
        {
            Upah = upahPerjam;
            Jam = jamKerja;
        }
    ...
    public class KomisiKaryawan : Karyawan
    {
        ...
        public KomisiKaryawan(string Depan, string Belakang, string ssn, decimal penjualan, decimal tingkat): base(Depan, Belakang, ssn)
        {
    ...
    public class KomisiTambahanKaryawan : KomisiKaryawan
    {
        ...
        public KomisiTambahanKaryawan(string Depan, string Belakang, string ssn, decimal penjualan, decimal tingkat, decimal gaji): base(Depan, Belakang, ssn, penjualan, tingkat)
        {
            GajiPokok = gaji;
        }
