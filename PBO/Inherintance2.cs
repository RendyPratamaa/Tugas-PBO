...
namespace Inheritance2
{
    public class KomisiKaryawan
    {
        ...
        public class KomisiTambahanKaryawan : KomisiKaryawan
        {
            ...
            public KomisiTambahanKaryawan(string namaDepan, string namaBelakang,string socialSecurityNumber, decimal penjualanKotor, decimal tingkatKomisi, decimal gajiPokok) : base(namaDepan, namaBelakang, socialSecurityNumber, penjualanKotor, tingkatKomisi)
            {
                GajiPokok = gajiPokok; 
            }
